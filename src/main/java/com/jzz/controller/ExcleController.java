...
import com.jzz.service.ExcleService;
import com.jzz.util.ExcelListener;
...
//    这是导入 Excel 的控制器，实现思路与导入的思路类似，不过这个不需添加响应头信息。
    ...
    public String importExcel(@RequestParam("file") MultipartFile file) throws IOException {
        ...
        //传入参数
        ExcelReader excelReader = new ExcelReader(inputStream, ExcelTypeEnum.valueOf(suffix.toUpperCase()), null, listener);
        //读取信息
